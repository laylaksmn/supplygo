    ...
    <section class="section products">
      <div class="section-header">
        ...
        <div class="controls">
          ...
          <a href="tracking/product_create.php" class="btn">+ Tambah Produk</a>
            ...
            <?php else: ?>
              <?php foreach ($products as $p): ?>
                <tr>
                  ...
                  <td class="actions">
                    <a href="tracking/product_edit.php?id=<?= $p['id'] ?>" class="btn btn-edit">Edit</a>
                    <form action="tracking/product_delete.php" method="post" class="inline" onsubmit="return confirm('Yakin hapus produk ini?');">
